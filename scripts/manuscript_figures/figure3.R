...
pdf(paste(pathFigures, "Figure3.pdf", sep=""), width=4.85, height=5.75)
...
for(type in c("tnt.meric", "grades")){
    for(direction in c("up", "down")){
        ...
        if(type=="tnt.meric" & direction=="up"){
            ylim=c(0,70)
            tinyy=1.5
        }

        if(type=="tnt.meric" & direction=="down"){
            ylim=c(0,50)
            tinyy=2
        }

        if(type=="grades" & direction=="up"){
            ylim=c(0,40)
            tinyy=1
        }

        if(type=="grades" & direction=="down"){
            ylim=c(0,20)
            tinyy=0.5
        }
